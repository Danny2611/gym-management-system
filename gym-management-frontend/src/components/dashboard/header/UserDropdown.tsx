...
export default function UserDropdown() {
  ...
  const renderAvatar = () => {
    // Nếu có avatar và không phải là đường dẫn mặc định
    if (user?.avatar && !user.avatar.includes("avatar-placeholder")) {
      return (
        <img
    ...
    <div className="relative">
      ...
      >
        ...
        <span className="text-theme-sm mr-1 block font-medium">
          {user?.name || "User"} {/* Hiển thị tên người dùng từ context */}
        </span>
        <svg
      ...
      >
        <div>
          ...
          <span className="text-theme-xs mt-0.5 block text-gray-500 dark:text-gray-400">
            ...
            {/* Hiển thị email người dùng từ context */}
          </span>
        </div>
